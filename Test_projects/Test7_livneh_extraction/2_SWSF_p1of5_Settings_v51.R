...
dir.prj <- "/home/charles/Livneh/Test"
...
dir.external <- "/media/charles/SOILWAT_DATA/GIS/Data"
...
do.ExtractExternalDatasets <- c(
    ...
    "GriddedDailyWeatherFromLivneh2013_NorthAmerica", 1, # 1/16 degree resolution
