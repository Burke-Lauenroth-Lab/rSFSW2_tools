...
if(interactive()) {
	dir.prj <- normalizePath(file.path(".", "Test_projects", "Test4_AllOverallAggregations_snow"))
	setwd(dir.prj)
}
...
actions <- c("external", "map_input", "create", "execute", "aggregate", "concatenate", "check")
