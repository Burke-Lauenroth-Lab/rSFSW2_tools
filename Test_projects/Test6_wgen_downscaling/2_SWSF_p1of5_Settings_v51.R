...
if(interactive()) {
	dir.prj <- normalizePath(file.path(".", "tests", "Test_projects", "Test6_wgen_downscaling"))
	setwd(dir.prj)
}
...
dir.external <- "/Volumes/Prj06_Albedo_HD1/BigData/Data"
...
downscaling.method			<- c("raw", "delta", "hybrid-delta-3mod", "wgen-package")				#one or multiple of "raw", "delta" (Hay et al. 2002), "hybrid-delta" (Hamlet et al. 2010), "hybrid-delta-3mod" or "wgen-package"
